    ...
    const element = `<div class="flex flex-col overflow-hidden rounded-2xl border-1 border-t-0 backdrop-blur border-gray-900 from-white/15 to-white/4 bg-gradient-to-br shadow-[rgba(255,255,255,0.2)_0px_-2px_0px_0px] group">
            ...
            <div class=" p-5 flex flex-col gap-10">
              <div class="flex flex-col gap-4">
                <div class="flex gap-4"><h1 class="font-bold text-2xl">${name}</h1><span class="flex px-2 py-0.5 rounded-md bg-gray-400/10 gap-0.5 items-center"><img src="/star-01%201.fbb0e8a3.svg" class="h-4 w-4 "><p class="text-gray-400 ">${stargazers_count}</p></span></div>
            ...
            <div class="flex flex-col gap-4 items-start">
              <a href="https://github.com/Qkari17" target="_blank" rel="noopener noreferrer" class="border-1 border-gray-700 bg-gray-900 px-5 py-4 flex gap-2 text-cyan-500 rounded-lg font-bold hover:bg-white/10"><img src="/browser%201.70ffedfe.svg"  class="w-6 h-6">View demo</a>
              <a href="${html_url}" target="_blank" rel="noopener noreferrer" class="border-1 border-gray-700 bg-gray-900 px-5 py-4 flex gap-2 text-cyan-500 rounded-lg font-bold hover:bg-white/10"><img src=/github.ad0e4991.svg class="w-6 h-6">Source code</a>
            </div>
            </div>
          </div>`
